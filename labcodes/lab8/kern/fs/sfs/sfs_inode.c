...
sfs_io_nolock(struct sfs_fs *sfs, struct sfs_inode *sin, void *buf, off_t offset, size_t *alenp, bool write) {
  ...
  //LAB8:EXERCISE1 2013011377 HINT: call sfs_bmap_load_nolock, sfs_rbuf, sfs_rblock,etc. read different kind of blocks in file
	/*
	...
	*/
    ...
    {
        size_t blkendpos = (blkno + 1) * SFS_BLKSIZE;
        size = (blkendpos > endpos) ? (endpos - alen - offset) : (blkendpos - alen - offset);
        blkoff = SFS_BLKSIZE - (blkendpos - alen - offset);
